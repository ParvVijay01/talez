...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    Provider.of<ChatProvider>(Get.context!, listen: false)
        .updateCurrentRouteStatus(status: true);
    _isLoggedIn =
    ...
    if (_isLoggedIn) {
      ...
      if (_isFirst) {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(1, widget.orderId, true);
      } else {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(1, widget.orderId, false);
        _isFirst = false;
      }
    }
  }
  ...
  void dispose() {
    super.dispose();
    Provider.of<ChatProvider>(Get.context!, listen: false)
        .updateCurrentRouteStatus(status: false);
  }
                    ...
                    child: ClipRRect(
                      ...
                      child: FadeInImage.assetNetwork(
                        ...
                        imageErrorBuilder: (c, t, o) =>
                            Image.asset(isAdmin ? Images.logo : Images.profile),
                      ),
                    ),
                  ),
                ],
                                                                ...
                                                                child:
                                                                    Container(
                                                                        decoration: const BoxDecoration(
                                                                            color: Colors
                                                                                .white,
                                                                            borderRadius: BorderRadius.all(Radius.circular(Dimensions
                                                                                .paddingSizeDefault))),
                                                                        child:
                                                                            const Padding(
                                                                          padding:
