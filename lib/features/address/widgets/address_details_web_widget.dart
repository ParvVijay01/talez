    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(
              child: Selector<AddressProvider, String?>(
                  selector: (context, addressProvider) =>
                      addressProvider.countryCode,
                  builder: (context, countryCode, child) {
                    return CustomTextFieldWidget(
                      countryDialCode: addressProvider.countryCode,
                      onCountryChanged: (CountryCode value) => addressProvider
                          .setCountryCode(value.dialCode ?? '+91',
                              isUpdate: true),
                      isRequired: true,
              ...
              return SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => InkWell(
                    onTap: () =>
                        addressProvider.updateAddressIndex(index, true),
                    child: Container(
                      padding: const EdgeInsets.symmetric(
                      ...
                      child: Row(children: [
                        CustomAssetImageWidget(
                          index == 0
                              ? Images.homeIcon
                              : index == 1
                                  ? Images.workPlaceIcon
                                  : Images.mapIcon,
                          color: index == addressProvider.selectAddressIndex
        ...
        Row(children: [
          ...
          Expanded(
              child: CustomTextFieldWidget(
            title: getTranslated('pincode', context),
            hintText: getTranslated('000000', context),
            isShowBorder: true,
